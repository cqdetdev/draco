...
// WriteAttributes writes a slice of Attributes x to protocol.Writer w.
...
// WriteInitialAttributes writes a slice of Attributes x to protocol.Writer w. WriteInitialAttributes is used when
